...
import { mockLocations, mockUsers, mockVehicles, getVehiclesAtLocation } from '@/mockdata';
...
const LocationDetail: React.FC = () => {
  ...
  const usersAtLocation = mockUsers.filter(user => user.location.id === id);
  const vehiclesAtLocation = getVehiclesAtLocation(id);
